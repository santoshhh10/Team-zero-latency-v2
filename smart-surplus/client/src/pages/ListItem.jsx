...
export default function ListItem() {
  ...
  async function submit(e) {
    ...
    // Don’t allow submit before photo step
    if (step < 3) {
      setStep(3)
      return
    }

    // Require a photo (remove this if truly optional)
    if (!form.imageFile) {
      toast.error('Please add a photo before publishing')
      return
    }
    ...
    try {
      ...
      fd.append('image', form.imageFile) // field name must be 'image'
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <form
        ...
        className="grid grid-cols-1 gap-3 glass p-4"
      >
        {step === 0 && (
          <>
        ...
        {step === 3 && (
          <>
            <div>
              <div className="text-sm text-gray-400 mb-2">Photo (required)</div>
